...
/*****************************************************************************
 * thread_policy.h - CPU topology detection and worker-count policy
 *****************************************************************************
 * Header-only with zero VLC/FFmpeg deps. Split from threading.h (ARCH-3):
 * this half is pure policy; the pthread dispatch gate lives in pool_gate.h.
 *
...
#ifndef AUTOUPSCALE_THREAD_POLICY_H
#define AUTOUPSCALE_THREAD_POLICY_H
